...
def process_song_file(cur, filepath):
    ...
    i/p: cursor, filepath
    returns: None
    This function takes a json file (song metadata) as input and extracts
    the necessary attributes needed for the songs and the artists table,
    transforms it and uploads it onto the relational database
    """
    # open song file
